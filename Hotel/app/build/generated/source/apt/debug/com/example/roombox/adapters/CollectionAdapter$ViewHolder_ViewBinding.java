...
public class CollectionAdapter$ViewHolder_ViewBinding implements Unbinder {
  private CollectionAdapter.ViewHolder target;

  @UiThread
  public CollectionAdapter$ViewHolder_ViewBinding(CollectionAdapter.ViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CollectionAdapter.ViewHolder target = this.target;
